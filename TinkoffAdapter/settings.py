"""
Django settings for TinkoffAdapter project.
...
ROOT_URLCONF = 'TinkoffAdapter.urls'
...
WSGI_APPLICATION = 'TinkoffAdapter.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'log', str(date.today()) + '-debug.log'),
            'formatter': 'simple',
        },
    },
    'loggers': {
