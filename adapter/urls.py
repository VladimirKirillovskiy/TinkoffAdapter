...
urlpatterns = [
    ...
    path('market/stocks/earn/<str:ticker>/', ad.QuartEarnings.as_view(), name='earnings'),
    path('market/stocks/nextearns/<str:ticker>/', ad.NextEarns.as_view(), name='next earnings'),
    path('market/stocks/info/<str:ticker>/', ad.Info.as_view(), name='info'),
    path('market/stocks/dividends/<str:ticker>/', ad.Dividends.as_view(), name='dividends'),
    path('market/stocks/nextdivs/<str:ticker>/', ad.NextDivs.as_view(), name='next dividends'),
